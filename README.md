...
[🚀 安装与使用 / Installation](#-安装与使用--installation) • [🧭 上游归属 / Upstream](#-上游归属--upstream) • [📄 开源协议 / License](#-开源协议--license)
...
本仓库是基于上游开源项目 [heider-x/vela](https://github.com/heider-x/vela) 的 GPL-3.0 二次开发版本，保留上游项目来源、原作者署名和 GPL-3.0 开源协议。

This repository is a modified GPL-3.0 fork of the upstream [heider-x/vela](https://github.com/heider-x/vela) project. It preserves upstream attribution and license notices.

本分支不代表上游官方版本，也不提供个人联系方式、微信群、赞助二维码或推荐注册链接。
...
请以当前 GitHub 仓库的 Releases 页面为准；如果尚未发布预构建安装包，请从源码构建。
- **macOS**: `.dmg` 安装包
...
本项目基于上游 [heider-x/vela](https://github.com/heider-x/vela) 修改，原项目作者与贡献者保留其对应署名和权利。

This project is based on the upstream [heider-x/vela](https://github.com/heider-x/vela) project. Upstream authors and contributors retain their attribution and rights.

本二次开发分支不提供个人联系方式、微信群、赞助二维码或推荐注册链接，避免用户误认为该分支代表上游官方支持渠道。
...
> 二次开发分支的问题请以当前仓库 Issues 为准；上游项目问题请前往 [heider-x/vela](https://github.com/heider-x/vela)。
...
**Based on [heider-x/vela](https://github.com/heider-x/vela), released under GPL-3.0.**
